...
_G.packer_plugins = {
  ...
  ["gitsigns.nvim"] = {
    config = { "\27LJ\1\2\5\0\0\4\0\n\0\r4\0\0\0%\1\1\0>\0\2\0027\0\2\0003\1\b\0003\2\3\0003\3\4\0:\3\5\0023\3\6\0:\3\a\2:\2\t\1>\0\2\1G\0\1\0\fkeymaps\1\0\0\tn [g\1\2\1\0001&diff ? '[c' : '<cmd>Gitsigns prev_hunk<CR>'\texpr\2\tn ]g\1\2\1\0001&diff ? ']c' : '<cmd>Gitsigns next_hunk<CR>'\texpr\2\1\0\r\fnoremap\2\17v <leader>hr\29:Gitsigns reset_hunk<CR>\17n <leader>hb9<cmd>lua require\"gitsigns\".blame_line{full=true}<CR>\17n <leader>hs!<cmd>Gitsigns stage_hunk<CR>\17n <leader>hR#<cmd>Gitsigns reset_buffer<CR>\to ih#:<C-U>Gitsigns select_hunk<CR>\tx ih#:<C-U>Gitsigns select_hunk<CR>\17n <leader>hr!<cmd>Gitsigns reset_hunk<CR>\17n <leader>hU)<cmd>Gitsigns reset_buffer_index<CR>\17v <leader>hs\29:Gitsigns stage_hunk<CR>\17n <leader>hp#<cmd>Gitsigns preview_hunk<CR>\17n <leader>hS#<cmd>Gitsigns stage_buffer<CR>\17n <leader>hu&<cmd>Gitsigns undo_stage_hunk<CR>\nsetup\rgitsigns\frequire\0" },
    loaded = true,
...
try_loadstring("\27LJ\1\2\5\0\0\4\0\n\0\r4\0\0\0%\1\1\0>\0\2\0027\0\2\0003\1\b\0003\2\3\0003\3\4\0:\3\5\0023\3\6\0:\3\a\2:\2\t\1>\0\2\1G\0\1\0\fkeymaps\1\0\0\tn [g\1\2\1\0001&diff ? '[c' : '<cmd>Gitsigns prev_hunk<CR>'\texpr\2\tn ]g\1\2\1\0001&diff ? ']c' : '<cmd>Gitsigns next_hunk<CR>'\texpr\2\1\0\r\fnoremap\2\17v <leader>hr\29:Gitsigns reset_hunk<CR>\17n <leader>hb9<cmd>lua require\"gitsigns\".blame_line{full=true}<CR>\17n <leader>hs!<cmd>Gitsigns stage_hunk<CR>\17n <leader>hR#<cmd>Gitsigns reset_buffer<CR>\to ih#:<C-U>Gitsigns select_hunk<CR>\tx ih#:<C-U>Gitsigns select_hunk<CR>\17n <leader>hr!<cmd>Gitsigns reset_hunk<CR>\17n <leader>hU)<cmd>Gitsigns reset_buffer_index<CR>\17v <leader>hs\29:Gitsigns stage_hunk<CR>\17n <leader>hp#<cmd>Gitsigns preview_hunk<CR>\17n <leader>hS#<cmd>Gitsigns stage_buffer<CR>\17n <leader>hu&<cmd>Gitsigns undo_stage_hunk<CR>\nsetup\rgitsigns\frequire\0", "config", "gitsigns.nvim")
