...
_G.packer_plugins = {
  ...
  ["editorconfig-vim"] = {
    loaded = true,
    path = "/home/mrcjk/.local/share/nvim/site/pack/packer/start/editorconfig-vim",
  ...
  ["material.vim"] = {
    loaded = true,
    path = "/home/mrcjk/.local/share/nvim/site/pack/packer/start/material.vim",
  ...
  ultisnips = {
    loaded = true,
    path = "/home/mrcjk/.local/share/nvim/site/pack/packer/start/ultisnips",
  ...
  ["vim-polyglot"] = {
    loaded = true,
    path = "/home/mrcjk/.local/share/nvim/site/pack/packer/start/vim-polyglot",
  ...
  ["vim-test"] = {
    loaded = true,
    path = "/home/mrcjk/.local/share/nvim/site/pack/packer/start/vim-test",
