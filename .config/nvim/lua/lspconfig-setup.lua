...
local on_jdtls_attach = function(client, bufnr)
  ...
  buf_set_keymap('n', '<leader>ev', '<cmd>'..jdtls_str..'.extract_variable()<CR>', opts)
  buf_set_keymap('v', '<leader>ev', '<cmd>'..jdtls_str..'.extract_variable(true)<CR>', opts)
  buf_set_keymap('v', '<leader>em', '<cmd>'..jdtls_str..'.extract_method(true)<CR>', opts)
