...
vim.keymap.set('i', '<c-y>', '<Plug>(NeocompleteConfirm)')
vim.keymap.set('i', '<c-e>', '<Plug>(NeocompleteClose)')
vim.keymap.set('i', '<Esc>', '<Plug>(NeocompleteClose)')
vim.keymap.set('i', '<c-n>', '<Plug>(NeocompleteSelectNext)')
vim.keymap.set('i', '<c-p>', '<Plug>(NeocompleteSelectPrev)')
...
-- HACK: Currently required to close the neocomplete menu
-- when leaving insert mode
vim.api.nvim_create_autocmd('InsertLeave', {
  callback = function()
    require('neocomplete').core.menu:close()
  end,
  group = vim.api.nvim_create_augroup('mrcjk.completion', { clear = true }),
})
