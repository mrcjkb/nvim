...
vim.keymap.set('n', '<leader>tn', function() require('telescope').extensions.manix.search() end, { })
vim.keymap.set('n', '<leader>n*', function() require('telescope').extensions.manix.search({cword = true,}) end, { })
